...
public class ControlActivity extends Activity {
    ...
    private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ((ControlActivity.this.getPackageName()+".USB_PERMISSION").equals(action)) {
                ...
                synchronized (this) {
                    ...
                    if (intent.getBooleanExtra(UsbManager.EXTRA_PERMISSION_GRANTED, false)) {
                        if (device != null) {
                            Toast.makeText(ControlActivity.this, "Crazyradio attached", Toast.LENGTH_SHORT).show();
                        }
                    } else {
            ...
            if (UsbManager.ACTION_USB_DEVICE_DETACHED.equals(action)) {
                ...
                if (device != null && CrazyradioLink.isCrazyradio(device)) {
                    ...
                    Toast.makeText(ControlActivity.this, "Crazyradio detached", Toast.LENGTH_SHORT).show();
    ...
    private void radioScan() {
        new AsyncTask<Void, Void, ConnectionData[]>() {
            ...
            protected void onPreExecute() {
                mProgress = ProgressDialog.show(ControlActivity.this, "Radio Scan", "Searching for the Crazyflie...", true, false);
            }

            @Override
            protected ConnectionData[] doInBackground(Void... arg0) {
                try {
                    return CrazyradioLink.scanChannels(ControlActivity.this);
                } catch(IllegalStateException e) {
                    mException = e;
                    return null;
                }
            ...
            protected void onPostExecute(ConnectionData[] result) {
                ...
                if(mException != null) {
                    Toast.makeText(ControlActivity.this, mException.getMessage(), Toast.LENGTH_SHORT).show();
                } else {
...
//                  result[2] = new ConnectionData(125, 2);
                    ...
                    if (result != null && result.length > 0) {
                        ...
                        Toast.makeText(ControlActivity.this, "No connection found", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        }.execute();
